...
#define _Tex03_DiffuseLightness_arr S_DefaultTerrain
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 hsvTorgb13_g29 = RGBToHSV( appendResult12.rgb );
			...
			float3 hsvTorgb17_g29 = HSVToRGB( float3(( _Tex01_DiffuseHue_Instance + hsvTorgb13_g29.x ),( _Tex01_DiffuseSaturation_Instance * hsvTorgb13_g29.y ),( hsvTorgb13_g29.z * _Tex01_DiffuseLightness_Instance )) );
			...
			float3 hsvTorgb13_g28 = RGBToHSV( appendResult18.rgb );
			...
			float3 hsvTorgb17_g28 = HSVToRGB( float3(( _Tex02_DiffuseHue_Instance + hsvTorgb13_g28.x ),( _Tex02_DiffuseSaturation_Instance * hsvTorgb13_g28.y ),( hsvTorgb13_g28.z * _Tex02_DiffuseLightness_Instance )) );
			...
			float3 hsvTorgb13_g30 = RGBToHSV( appendResult6.rgb );
			...
			float3 hsvTorgb17_g30 = HSVToRGB( float3(( _Tex03_DiffuseHue_Instance + hsvTorgb13_g30.x ),( _Tex03_DiffuseSaturation_Instance * hsvTorgb13_g30.y ),( hsvTorgb13_g30.z * _Tex03_DiffuseLightness_Instance )) );
			float4 weightedBlendVar23 = temp_output_77_0;
			float3 weightedAvg23 = ( ( weightedBlendVar23.x*hsvTorgb17_g29 + weightedBlendVar23.y*hsvTorgb17_g28 + weightedBlendVar23.z*hsvTorgb17_g30 + weightedBlendVar23.w*float3( 0,0,0 ) )/( weightedBlendVar23.x + weightedBlendVar23.y + weightedBlendVar23.z + weightedBlendVar23.w ) );
...
/*ASEBEGIN
Version=16400
546;63;1266;958;2570.832;1212.976;2.680482;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-1204.685,-993.3214;Float;False;InstancedProperty;_Power;Power;27;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;22;-1438.476,-631.3417;Float;False;SF_ColorShift;-1;;29;f3651b3e85772604cb45f632c7f608e7;0;4;26;FLOAT;0;False;27;FLOAT;0;False;28;FLOAT;0;False;23;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;20;-1438.476,376.66;Float;False;SF_ColorShift;-1;;30;f3651b3e85772604cb45f632c7f608e7;0;4;26;FLOAT;0;False;27;FLOAT;0;False;28;FLOAT;0;False;23;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;21;-1438.476,-135.3403;Float;False;SF_ColorShift;-1;;28;f3651b3e85772604cb45f632c7f608e7;0;4;26;FLOAT;0;False;27;FLOAT;0;False;28;FLOAT;0;False;23;COLOR;0,0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=C1B677210B29CBBCD6AAE1345BF451AB24FD3234