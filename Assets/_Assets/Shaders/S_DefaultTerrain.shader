...
#define _Tex03_DiffuseLightness_arr S_DefaultTerrain
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_76_0 = ( temp_output_72_0 * _Tex03_Tile_Instance );
				...
				float4 staticSwitch65 = tex2D( _Tex03_Norm, temp_output_76_0.xy );
			#else
				float4 staticSwitch65 = float4( _FlatNorm , 0.0 );
			#endif
			float4 weightedBlendVar68 = i.vertexColor;
			float4 weightedAvg68 = ( ( weightedBlendVar68.x*float4( staticSwitch67 , 0.0 ) + weightedBlendVar68.y*float4( staticSwitch66 , 0.0 ) + weightedBlendVar68.z*staticSwitch65 + weightedBlendVar68.w*float4( 0,0,0,0 ) )/( weightedBlendVar68.x + weightedBlendVar68.y + weightedBlendVar68.z + weightedBlendVar68.w ) );
			o.Normal = weightedAvg68.rgb;
			...
			float3 hsvTorgb13_g26 = RGBToHSV( appendResult12.rgb );
			...
			float3 hsvTorgb17_g26 = HSVToRGB( float3(( _Tex01_DiffuseHue_Instance + hsvTorgb13_g26.x ),( _Tex01_DiffuseSaturation_Instance * hsvTorgb13_g26.y ),( hsvTorgb13_g26.z * _Tex01_DiffuseLightness_Instance )) );
			...
			float3 hsvTorgb13_g25 = RGBToHSV( appendResult6.rgb );
			...
			float3 hsvTorgb17_g25 = HSVToRGB( float3(( _Tex03_DiffuseHue_Instance + hsvTorgb13_g25.x ),( _Tex03_DiffuseSaturation_Instance * hsvTorgb13_g25.y ),( hsvTorgb13_g25.z * _Tex03_DiffuseLightness_Instance )) );
			float4 weightedBlendVar23 = i.vertexColor;
			float3 weightedAvg23 = ( ( weightedBlendVar23.x*hsvTorgb17_g26 + weightedBlendVar23.y*hsvTorgb17_g23 + weightedBlendVar23.z*hsvTorgb17_g25 + weightedBlendVar23.w*float3( 0,0,0 ) )/( weightedBlendVar23.x + weightedBlendVar23.y + weightedBlendVar23.z + weightedBlendVar23.w ) );
...
/*ASEBEGIN
Version=16400
1927;1;1266;964;2195.246;1350.087;1.537654;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-3738.285,414.2709;Float;False;InstancedProperty;_Tex03_Tile;Tex03_Tile;18;0;Create;True;0;0;False;0;0;120;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-3787.702,-88.62228;Float;False;InstancedProperty;_Tex01_Tile;Tex01_Tile;0;0;Create;True;0;0;False;0;0;120;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-3754.26,100.7399;Float;False;InstancedProperty;_Tex02_Tile;Tex02_Tile;9;0;Create;True;0;0;False;0;0;120;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;22;-1438.476,-631.3417;Float;False;SF_ColorShift;-1;;26;f3651b3e85772604cb45f632c7f608e7;0;4;26;FLOAT;0;False;27;FLOAT;0;False;28;FLOAT;0;False;23;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;20;-1438.476,376.66;Float;False;SF_ColorShift;-1;;25;f3651b3e85772604cb45f632c7f608e7;0;4;26;FLOAT;0;False;27;FLOAT;0;False;28;FLOAT;0;False;23;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;65;-1554.576,1712.883;Float;False;Property;_Tex03_UseNormal;Tex03_UseNormal;24;0;Create;True;0;0;False;0;0;1;1;True;;Toggle;2;Key0;Key1;Create;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.WeightedBlendNode;68;-471.691,153.6572;Float;False;5;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=99D776D9B2B661CE2097D5A9704D316B4DF8933E