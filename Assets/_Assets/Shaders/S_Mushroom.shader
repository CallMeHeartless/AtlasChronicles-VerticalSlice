...
Shader "Custom/S_Mushroom"
{
	...
	SubShader
	{
		...
		{
			float4 color1 = IsGammaSpace() ? float4(0.5471698,0.3019758,0.3019758,0) : float4(0.2603273,0.07422106,0.07422106,0);
			o.Albedo = color1.rgb;
...
/*ASEBEGIN
Version=16400
1921;1;1278;970;865.475;611.8696;1.3;True;True
Node;AmplifyShaderEditor.ColorNode;1;-256,-94.5;Float;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;False;0;0.5471698,0.3019758,0.3019758,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;2;-166,138.5;Float;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BF752C7B8B1D9ABD8D95811CCB557114D8B66F10