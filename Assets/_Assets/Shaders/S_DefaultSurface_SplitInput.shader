...
#define _OcclusionIntensity_arr S_DefaultSurface_SplitInput
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 hsvTorgb13_g13 = RGBToHSV( appendResult72.rgb );
			...
			float3 hsvTorgb17_g13 = HSVToRGB( float3(( _DiffuseHue_Instance + hsvTorgb13_g13.x ),( _DiffuseSaturation_Instance * hsvTorgb13_g13.y ),( hsvTorgb13_g13.z * _DiffuseLightness_Instance )) );
			o.Albedo = hsvTorgb17_g13;
			...
			float4 temp_cast_10 = (_OcclusionContrast_Instance).xxxx;
			float lerpResult41 = lerp( _OcclusionHigh_Instance , _OcclusionLow_Instance , pow( tex2D( _Occlusion, uv_TexCoord75 ) , temp_cast_10 ).r);
...
/*ASEBEGIN
Version=16400
1927;7;1266;958;2956.052;458.6237;2.435646;True;False
...
Node;AmplifyShaderEditor.FunctionNode;51;-1453.621,-874.8996;Float;False;SF_ColorShift;-1;;13;f3651b3e85772604cb45f632c7f608e7;0;4;26;FLOAT;0;False;27;FLOAT;0;False;28;FLOAT;0;False;23;COLOR;0,0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=D72DC0C4AC5D731C8E9D3A9C825647A32485D9DE