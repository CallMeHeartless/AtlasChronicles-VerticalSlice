...
Shader "Custom/S_TreeLog"
{
	...
	SubShader
	{
		...
		{
			float4 color1 = IsGammaSpace() ? float4(0.3301887,0.2571659,0.132387,0) : float4(0.08908623,0.05379221,0.01580406,0);
			o.Albedo = color1.rgb;
...
Node;AmplifyShaderEditor.ColorNode;1;-315,-144.5;Float;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;False;0;0.3301887,0.2571659,0.132387,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=925233D22C7C472AC5FEEDC34E0E45ABEC37B52C