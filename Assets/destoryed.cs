...
public class destoryed : MonoBehaviour
{
    ...
    void Start()
    {
       ...
       int intRotationAroundCircle = 360 / m_intSecondaryItem;
        ...
        Vector3 gap = new Vector3(0.2f, 0, 0);


        for (int i = 0; i < m_intSecondaryItem; i++)
        {
            GameObject gOrb = GameObject.Instantiate(m_gSecondaryItemIs, gameObject.transform.position+ gap, Quaternion.identity);
